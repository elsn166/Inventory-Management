    ...
    var months = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'],
            ...
            DCalendar = function (elem, options) {
                ...
                this.calendar.find('.calendar-date-holder').on('click', '.calendar-dates .date:not(.date.month) a', function () {
                    ...
                    if (that.disabledDate(selectedDate))
                        return;
        ...
        getDays: function (newDate, callback) {
            ...
            for (var i = 1; i <= 6; i++) {
                ...
                while (day <= days) {
                    ...
                    if (that.disabledDate(d))
                        week[dayOfWeek].addClass('disabled');
                ...
                if (i === 1 || i > 4) {
                    ...
                    if (i === 1) {
                        ...
                        for (var a = 6; a >= 0; a--) {
                            ...
                            if (that.disabledDate(pmDate))
                                week[a].addClass('disabled');
    ...
    $.fn.dcalendarpicker = function (opts) {
        return $(this).each(function () {
            ...
            that.on('click', function (e) {
                ...
                if (ex_keys.indexOf(e.which) < 0 && that.data(DCAL_DATA).options.readOnly)
                    return false;
            });
