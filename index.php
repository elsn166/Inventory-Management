...
if ($result->num_rows > 0) {
    echo "<script type='text/javascript'>window.location='dashbord.php?&success=Account Login Successfully';</script>";
    }
    else{
            ...
            <article class="card-body mx-auto" style="min-width: 5rem;">
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group input-group">
                        ...
                        <input name="email" id="email"  class="form-control " placeholder="Email" type="text" required autofocus>
                    </div> 
                    <div class="form-group input-group">
                        <div class="input-group-prepend">
