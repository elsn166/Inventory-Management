...
//echo $id;
$sql = "SELECT * FROM bill WHERE invoiceno='$id' AND barcode='$barcode' ";
...
<span class="h2">Customer Name : </span><span class="h2" id="cun"><?php echo $customer; ?></span></br>
<span class="h2">Mobile: </span><span class="h2" id="cun"><?php echo $mobile; ?></span>
      <div class="row">
        <div class="col-12">
          <div class="card p-0 my-4 rounded-sm shadow">
            <div class="card-body" id="bod">
                <form action="stockedit.php" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="row my-4">
                        ...
                        <div class="col-4">
                          <h6>Color</h6>
                            <div class="form-outline input-group">
                                   <?php
                                    echo'<input type="text" name="color" id="color" class="form-control" value= "'.$color1.'" > ';
                                    ?>
                                    <!-- <label class="form-label" for="form12">Example label</label> -->
                                </div>  
                      ...
                      <!--    <div class="col-4">
                        ...
                        <!--  <div class="col-4">
                         ...
                         <!--<div class="col-4">
                              ...
                              <div class="form-outline input-group">
                                    <?php 
                                    echo'<input  name="Warranty" id="warranty" class="form-control" value="'.$Warranty.'">';
                                    ?>
                                    <!-- <label class="form-label" for="form12">Example label</label> 
                                </div>   
                          </div>-->
                        ...
                        <div class="row my-2">
                         <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-outline input-group">
                                    <?php echo'
                                    <input type="date" required name="returndate" id="returndate" class="form-control" >';
                                    ?>
                                    <!-- <label class="form-label" for="form12">Example label</label> -->
                                </div>
                            </div>
                             <div class="col-6">
                              <h6>Feedback</h6>
                                    <div class="form-outline input-group">
                                        <?php echo'
                                  <!--<textarea type="" name="paid" id="paid" class="form-control opacity-100" oninput="paidamount()" value="'.$paid.'">-->
                                    <textarea  name="feedback" id="paid" class="form-control  value="'.$paid.'">
...
<script>
    ...
    window.location.replace("https://papoosekart.staging-rdegi.com/invoice.php");
