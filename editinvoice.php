...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        echo '<tr>
                  ...
                  <td  hidden>'.$row["id"] .'</td>
                  <td>
                  <a href="delete3.php?action=edit&amp;id='.$row['id'].'&in='.$row['invoiceno'].'"><span class="btn btn-dark mx-1"><i class="fas fa-trash"></i></span></a>
                  <a href="edit2.php?action=edit&amp;id='.$row['id'].'&in='.$row['invoiceno'].'"><span class="btn btn-dark"><i class="fas fa-pen"></i></span></a></td>
                </tr>';
    }
} else {
    // echo "0 results";
...
$('#example').on('click', '#btn1', function() {
  ...
  $.post('edit.php',{postname:tus, dateva:tus1, timeva:tus2,id:id1},function(data){
        //alert(tus);
    window.location.replace("https://inventory.papoosekart.com/testing.php");
  });
});
...
//alert(tus);
    window.location.replace("https://inventory.papoosekart.com/billingedit.php");
  });
});
...
//alert(tus2);
//alert(tus3);
    window.location.replace("https://inventory.papoosekart.com/payscript.php");
