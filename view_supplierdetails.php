...
document.getElementById('search').value=jk;
 ...
 <form action="supplierdetails_insert.php" method="post">
                    <div class="row my-3">
                        <div class="col-6">
                            <h6>Supplier Name</h6>
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-outline input-group">
                                <input type="text" id="supplier_no" name="supplier_no" maxlength="10" pattern = "[0-9]{3}[0-9]{3}[0-9]{4}" class="form-control" />
                                <!-- <label class="form-label" for="form12">Example label</label> -->
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row my-3">
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-outline">
                                <textarea class="form-control" id="supplier_address" name="supplier_address" rows="4"></textarea>
