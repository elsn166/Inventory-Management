...
$sql = "SELECT * from bill WHERE invoiceno='$id' ";
...
if ($result->num_rows > 0) {
  ...
  while ($row1 = $result->fetch_assoc()) {
   ...
   $prfrom=$row1['purchase_from'];
    $newDate = date("d-m-Y", strtotime($date));
  }}
  ?>
  <input type="button" class="mx-3 mt-5" value="Print Invoice" id="but" onclick="javascript:printDiv('printablediv')" /> 
   <a href="invoice.php"><span class="btn btn-primary btn-sm">Back</span></a>
    <div id="printablediv">
 <h5 class="fs-4 text-center">RDEGI</h5>
  ...
  <div class="">
    <div class="container">
      <!--<div class="row">-->
      <!--              <div class="col-8">-->
      <!--              <img src="dist/images/Papoose_Logo2.png" class="" alt="Snow Aqua width="200" height="150" ">-->
      ...
      <!--               <p class="address fw-bold">Customer name:<?php echo $_SESSION["user"] ?></p>-->
      <!--              <p class="address fw-bold">Date: <?php echo $newDate?> </p>-->
      <!--              <p class="gst-no fw-bold">Invoice No: <?php echo $invoice?> </p>-->
      <!--              <p class="mobile-no fw-bold">Transport:</p>-->
      <!--              <p class="mobile-no fw-bold">Purchased Through:<?php echo $prfrom?></p> -->
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          <table>
           <thead> 
              <tr>
                <th scope="col" colspan="4"><img src="dist/images/rdegi.jpg" class="" alt="Snow Aqua width="100" height="150" ">
                    <p class="address fw-bold">Address:7.3.200,porkudam Nagar,</br>A.I.B.E.A A Colony ,</br>Paravai-625402</p>
                    <p class="gst-no fw-bold">Our Website: rdegi.com </p>
                <th scope="col"><p class="address fw-bold">Customer name:<?php echo $_SESSION["user"] ?></p>
                    <p class="address fw-bold">Date: <?php echo $newDate?> </p>
                    <p class="gst-no fw-bold">Invoice No: <?php echo $invoice?> </p>
                    <p class="mobile-no fw-bold">Transport:</p>
                    <p class="mobile-no fw-bold">Purchased Through:<?php echo $prfrom?></p> </th>
              </tr>
            </thead>
  ...
  while ($row1 = $result->fetch_assoc()){
   ...
   $newDate = date("d-m-Y", strtotime($date));
        ...
        echo'
              ...
              ?>
<?php
 $sql1 = "SELECT SUM(qty) AS totalqty  FROM bill WHERE invoiceno='$id'";
...
$sql11 = "SELECT SUM(total) AS total  FROM bill WHERE invoiceno='$id'";
 ...
 $counter = 0;
  ...
  <tfoot class="foot">
    ...
    <tr>
      ...
      <td class="text-end"><p class="my-auto mx-3">Total Pcs:<?php echo $qty11 ?></p></td>
      <td>Grand Total</td>
      <td class="text-center"><?php echo $gtot?></td>
    </tr>
  </tfoot>
          </table>
        </div>
