...
$sql2 = "UPDATE bill SET barcode='$barcode',category='$Category',mobiles='$mobiles',color='$color',model='$model',ram='$ram',storage='$storage',Warranty='$Warranty',
ime='$ime',price='$price',mrp='$mrp',qty='$qty',total='$total',barcode='$barcode',discount='$discount',paid='$paid',balance='$balance',gtotal='$gtotal' WHERE id='$id'";

if ($conn->query($sql2) === TRUE){
    echo "<script type='text/javascript'>window.location='dashbord.php?&success=Account updated Successfully';</script>";
} else {
