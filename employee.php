...
<div id="here">
      ...
      <div class="invo mx-2">
               <a href="view_employee.php" class="btn btn-primary shadow-sm" style="vertical-align: middle;"><i class="fas fa-users mx-1"></i> Add Employees</a>
      </div>

                                    </div>
                                    <h6 class="mb-0">Empolyee Details </h6>
                                </div>
                                <div class="card-body">
...
$cuspass=$row['cus_password'];
$cusadd=$row['cus_address'];
$cusrole=$row['cus_role'];
$id=$row['id'];
          ...
          <tbody>
            <tr>
                ...
                <td>
                  ...
                  <a href="updateemp.php?action=edit&amp;id='.$row['id'].'"><span class="btn btn-dark"><i class="fas fa-pen"></i></span></a></td>
            </tr>
